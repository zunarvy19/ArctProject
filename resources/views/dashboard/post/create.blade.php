...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <p class="my-2 h3 border-bottom fw-semibold">Create New Post</p>
        ...
        <div class="col-lg-8">
            <form method="POST" action="/dashboard/post" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="contoh-contoh-contoh" value="{{old('slug')}}">
                @error('slug')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
